...
class LogSpiderGetInfo extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'log:spiderinfo';
     ...
     * @var string
     */
    protected $description = 'Get info list domain';
    ...
    {
        \Log::info('Start get info' . \Carbon\Carbon::now());
        $this->doAutoGetInfoWebFromData();
    }
}
