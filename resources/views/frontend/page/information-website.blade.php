                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td class="td-parameter">United State</td>
                                                        <td class="td-parameter">25.2%</td>
                                                        <td class="td-parameter">3</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="td-parameter">Vietnam</td>
                                                        <td class="td-parameter">50%</td>
                                                        <td class="td-parameter">1</td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                            <div class="col-md-12">
                                                <svg version="1.1"
                                                    ...
                                                    <g>
                                                        <path cs="100,100"
                                                              d="M0.5,0.5 L758.5,0.5 L758.5,274.5 L0.5,274.5 Z"
                                                              fill="#DDEEFF" stroke="#FFFFFF" fill-opacity="0"
                                                              stroke-width="1"
                                                              stroke-opacity="0"></path>
                                                        <rect x="0.5" y="0.5" width="759" height="275" rx="0" ry="0"
                                                              stroke-width="0" fill="#000" stroke="#000"
                                                              fill-opacity="0.001"
                                                              stroke-opacity="0.001"></rect>
                                                    </g>
                                                    <g></g>
                                                    <g></g>
                                                    <g></g>
                                                    <g></g>
                                                    <g>
                                                        <g transform="translate(167,0) scale(1)">
                                                            <g transform="translate(0,0) scale(0.4224659707017374)">
                                                                <path cs="100,100"
                                                                      ...
                                                                      fill="#DDDDDD" fill-opacity="0.5" stroke="#FFFFFF"
                                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                                <path cs="100,100"
                                                                ...
                                                                <path cs="100,100"
                                                                      ...
                                                                      fill="rgb(95,193,119)" fill-opacity="1"
                                                                      stroke="#FFFFFF"
                                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                                <path cs="100,100"
                                                                ...
                                                                <path cs="100,100"
                                                                      ...
                                                                      fill="rgb(90,191,115)" fill-opacity="1"
                                                                      stroke="#FFFFFF"
                                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                                <path cs="100,100"
                                                                ...
                                                                <path cs="100,100"
                                                                      ...
                                                                      fill="rgb(89,191,115)" fill-opacity="1"
                                                                      stroke="#FFFFFF"
                                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                                <path cs="100,100"
                                                                ...
                                                                <path cs="100,100"
                                                                      ...
                                                                      fill="rgb(91,192,117)" fill-opacity="1"
                                                                      stroke="#FFFFFF"
                                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                                <path cs="100,100"
                                                                ...
                                                                <path cs="100,100"
                                                                      ...
                                                                      fill="rgb(52,183,85)" fill-opacity="1"
                                                                      stroke="#FFFFFF"
                                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                                <path cs="100,100"
                                                ...
                                                var chart = new CanvasJS.Chart("chartUpstream",
                                                    {
                                                        ...
                                                        data: [
                                                            ...
                                                            {
                                                                dataPoints: [
                                                                    {x: 1, y: 10, label: "Venezuela"},
                                                                    {x: 2, y: 20, label: "Saudi"},
                                                                    {x: 3, y: 15, label: "Canada"},
                                                                    {x: 4, y: 18, label: "Iran"},
                                                                    {x: 5, y: 50, label: "Russia"}
                                                                ]
                                                            }
                                                        ]
                                                    });
