                        ...
                        <div class="row" style="margin: 0">
                            <div class="sidebar-inf">
                                <div class="col-md-1 col-sm-1 col-xs-1"
                                     style="height: 100%;display: flex;justify-content: center;align-items: center;padding-right: 0">
                                                ...
                                                var chart = new CanvasJS.Chart("chartUpstream",
                                                    {
                                                        ...
                                                        data: [
                                                            ...
                                                            {
                                                                dataPoints: [
                                                                    {x: 1, y: {{trim($upstream_sites[0][0]->rate,'%')}}, label: "{{$upstream_sites[0][0]->site}}"},
                                                                    {x: 2, y: {{trim($upstream_sites[1][0]->rate,'%')}}, label: "{{$upstream_sites[1][0]->site}}"},
                                                                    {x: 3, y: {{trim($upstream_sites[2][0]->rate,'%')}}, label: "{{$upstream_sites[2][0]->site}}"},
                                                                    {x: 4, y: {{trim($upstream_sites[3][0]->rate,'%')}}, label: "{{$upstream_sites[3][0]->site}}"},
                                                                    {x: 5, y: {{trim($upstream_sites[4][0]->rate,'%')}}, label: "{{$upstream_sites[4][0]->site}}"}
                                                                ]
                                                            }
                                                        ]
                                                    });
