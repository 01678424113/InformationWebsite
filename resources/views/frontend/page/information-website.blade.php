                ...
                <div class="col-md-12">
                    ...
                    <div class="traffic-over">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <svg version="1.1" style="width: 759px; height: 275px;margin-bottom: 10px">
                                    <desc>JavaScript chart by amCharts 3.4.1</desc>
                                    <g>
                                        <path cs="100,100" d="M0.5,0.5 L758.5,0.5 L758.5,274.5 L0.5,274.5 Z"
                                              fill="#DDEEFF" stroke="#FFFFFF" fill-opacity="0" stroke-width="1"
                                              stroke-opacity="0"></path>
                                        <rect x="0.5" y="0.5" width="759" height="275" rx="0" ry="0"
                                              stroke-width="0" fill="#000" stroke="#000" fill-opacity="0.001"
                                        ...
                                        <g transform="translate(167,0) scale(1)">
                                            <g transform="translate(0,0) scale(0.4224659707017374)">
                                                ...
                                                <path cs="100,100"
                                                      ...
                                                      fill="rgb(95,193,119)" fill-opacity="1" stroke="#FFFFFF"
                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                <path cs="100,100"
                                                ...
                                                <path cs="100,100"
                                                      ...
                                                      fill="rgb(90,191,115)" fill-opacity="1" stroke="#FFFFFF"
                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                <path cs="100,100"
                                                ...
                                                <path cs="100,100"
                                                      ...
                                                      fill="rgb(89,191,115)" fill-opacity="1" stroke="#FFFFFF"
                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                <path cs="100,100"
                                                ...
                                                <path cs="100,100"
                                                      ...
                                                      fill="rgb(91,192,117)" fill-opacity="1" stroke="#FFFFFF"
                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                <path cs="100,100"
                                                ...
                                                <path cs="100,100"
                                                      ...
                                                      fill="rgb(52,183,85)" fill-opacity="1" stroke="#FFFFFF"
                                                      stroke-opacity="1" stroke-width="0.5"></path>
                                                <path cs="100,100"
