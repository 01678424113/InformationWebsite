            ...
            <div class="tab-pane fade in active" id="service-branding">
                ...
                <div class="section-text">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                            Donec vel ultricies purus. Nam dictum sem, ipsum aliquam . Etiam sit amet fringilla
                            lacus.
                ...
                <div class="section-text">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                            ...
                            elementum.
                            Nam varius at ipsum id dignissim. Nam a tincidunt ante lorem. Pellentesque suscipit
                            ante
            ...
            <div class="tab-pane fade" id="service-graphic">
                ...
                <div class="section-text">
                    <div class="row">
                        <div class="col-md-4 mb-md-40 mb-xs-30">
                            <blockquote class="mb-0">
                                <p>
                                    ...
                                    one you&rsquo;re with isn&rsquo;t doing the job, there&rsquo;s always
                                    another.
                                </p>
                                <footer>
                                    Chip Kidd
                        ...
                        <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                            Lorem ipsum dolor sit semper amet, consectetur adipiscing elit. In maximus ligula
                            metus pellentesque
                            mattis. Donec vel ultricies purus. Nam dictum sem, ipsum aliquam . Praesent sed nisi
                            eleifend,
                ...
                <div class="section-text">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 mb-sm-50 mb-xs-30">
                            ...
                            dictum ante sit
                            amet enim interdum semper. Vestibulum odio justo, faucibus et dictum eu, malesuada
                            nec neque.
